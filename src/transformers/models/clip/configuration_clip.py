...
class CLIPConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        # logit_scale_init_value=2.6592 is chosen by OpenAI as np.log(1 / 0.07)). Will be used as e ^ 2.65926 = 14.2857 multiply text-image matrix
...
# example openai/clip-vit-base-patch32 config.json
# {
#   "architectures": [
#     "CLIPModel"
#   ],
